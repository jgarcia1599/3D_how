...
BABYLON.DefaultLoadingScreen.prototype.hideLoadingUI = function(){
      ...
      for (mesh in meshes) {
        ...
        scene.registerBeforeRender(function () {
          ...
          if (timeofDay == false) {
            ...
            // shoreLineTexture.diffuseColor = new BABYLON.Color3(0.7, 0.6, 0.5);
            // shoreLineTexture.emissiveColor = new BABYLON.Color3(0.7, 0.6, 0.5);  
          ...
          if (timeofDay == true) {
            light.intensity = 1.0;
            // shoreLineTexture.diffuseColor = new BABYLON.Color3(0.7, 0.6, 0.5);
            // shoreLineTexture.emissiveColor = new BABYLON.Color3(0.5,0.5,0.5);
            // groundMaterial.diffuseColor = new BABYLON.Color3(0.02, 0.03, 0.17);
            // groundMaterial.emissiveColor = new BABYLON.Color3(0.02, 0.03, 0.17);
            //assign rain ps to mysystem var
            if (weatherState == "rainy" && isRaining == false) {
  ...
  var desertSceneCreate = function (timeofDay, currentWeather) {
    ...
    var source = BABYLON.Mesh.CreateBox("source", 3.0, scene);
    source.position = new BABYLON.Vector3(0, -26, 0);
    // Create a particle system
    var particleSystem = new BABYLON.ParticleSystem("particles", 2000, scene);
